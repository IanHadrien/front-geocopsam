...
export default function TopBar() {
  return (
    <div id='topbar' className='fixed px-2 top-0 flex w-full items-center justify-between h-[55px] flex-shrink-0 bg-verde-texture1'>
      <div className="px-2.5 flex items-center pt-1">
        <div className="flex items-center">
          <div className="xl-1038:hidden mr-4">
            {/* <DropdownMenuUi /> */}
          </div>
