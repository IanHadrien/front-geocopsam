...
export default function Maps () {
  const { isLoaded } = useJsApiLoader({
    id: 'AIzaSyD5Bp5IIRsxLDdMS-MMmehi1r1OLtwRb9Y',
    googleMapsApiKey: 'AIzaSyD5Bp5IIRsxLDdMS-MMmehi1r1OLtwRb9Y',
  });
  ...
  const markers = [
    ...
    },
    {
      ...
      status: "inair",
      location: {
        lat: -15.712161812268716,
        lng: -42.66307096830767,
      },
    },
    {
      ...
      status: "incident",
      location: {
        lat: -15.717104694958616,
        lng: -42.667155135773356
      },
    },
    {
      ...
      status: "offline",
      location: {
        lat: -15.703802189950522,
        lng: -42.68492208793661
      },
    },
  ];
