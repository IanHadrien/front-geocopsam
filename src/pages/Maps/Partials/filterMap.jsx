...
export default function FilterMap({ handleFilter, resetFilter }) {
  ...
  return (
    <div className="absolute top-[10px] left-48">
      <Menubar className="border-none shadow-none rounded-sm">
        <MenubarMenu className="rounded-none">
          <MenubarTrigger className="bg-white space-x-1 cursor-pointer flex max-w-xs items-center text-sm focus:outline-none focus:ring-2 focus:ring-verde-texture1 focus:ring-offset-2inline-flex border-gray-200 leading-4 font-medium text-gray-500 hover:text-gray-700 transition ease-in-out duration-150">
            <span className="font-medium text-black text-lg">Filtro</span>
            <span className="pl-1">
              <IoIosArrowDown />
            </span>
          </MenubarTrigger>
